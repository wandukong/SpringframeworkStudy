...
<ul class="nav flex-column">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-1">Ch12.</span>
			<a class="text-warning" href="${pageContext.request.contextPath}/ch12/content">View/BeanNameViewResolver</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-1">Ch13.</span>
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-1">Ch15.</span>
			<a class="text-warning" href="${pageContext.request.contextPath}/ch15/content">AOP(Aspect Oriented Programming)</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-1">Ch16.</span>
			<a class="text-warning" href="${pageContext.request.contextPath}/ch16/content">Transaction</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-1">Ch17.</span>
			<a class="text-warning" href="${pageContext.request.contextPath}/ch17/content">Spring Security</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-1">Ch18.</span>
			<a class="text-warning" href="${pageContext.request.contextPath}/ch18/content">ExecutorService</a>
		</h6>
	</li>
</ul>